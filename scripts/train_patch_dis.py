...
from sgan.models import PatchedTrajectoryDiscriminator as TrajectoryDiscriminator
...
parser.add_argument("--variety_loss_mode",choices=["min", "max","median", "avg", "rand"], default="min")
def init_weights(m):
